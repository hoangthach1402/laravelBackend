                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('vocabularies.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="english" id="english" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        </div>

                        <div class="mb-4">
                            <label for="vietnamese" class="block text-gray-700 text-sm font-bold mb-2">Tiếng Việt:</label>
                            <input type="text" name="vietnamese" id="vietnamese" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        </div>

                        <div class="mb-4">
                            <label for="pronunciation" class="block text-gray-700 text-sm font-bold mb-2">Phiên âm:</label>
                            <input type="text" name="pronunciation" id="pronunciation" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
